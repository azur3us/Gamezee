...
namespace Gamezee.Controllers
{
    ...
    public class GameGroupMemberController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateGameGroupMemberDTO dto)
        {
        ...
        public async Task<IActionResult> Update(string gameGroupId, string userId, [FromBody] UpdateGameGroupMemberDTO dto)
        {
